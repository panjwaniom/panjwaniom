...
|---|---|---|
| [macOS Portfolio](https://ompanjwani.vercel.app) | React · CSS3 | Lighthouse 100 · 0.6s FCP · zero third-party UI libs |
| [TaskToDo – Task Manager](https://github.com/panjwaniom/task-todo-web-app) | React · Node.js · Express · MySQL | JWT auth · HTTP 304 caching · full-stack |
